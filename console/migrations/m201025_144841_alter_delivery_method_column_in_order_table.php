 ...
 */
class m201025_144841_alter_delivery_method_column_in_order_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-order-delivery_method_id-delivery-id', $this->tableName, 'delivery_method_id', 'delivery_method', 'id', 'SET NULL');
    }
